...
import { DEFAULT_SETTINGS as DEFAULT_NOTIFICATION_SETTINGS } from '@/electron/main/notifications/types';
...
beforeEach(() => {
  window.duneDesktop = {
    ...
    getNotificationSettings: vi.fn(() => Promise.resolve(DEFAULT_NOTIFICATION_SETTINGS)),
    ...
    updateNotificationSettings: vi.fn(() => Promise.resolve(DEFAULT_NOTIFICATION_SETTINGS)),
  };
