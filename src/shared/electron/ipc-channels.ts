...
export const ipcChannels = {
  ...
  projectsArchive: 'dune:projects:archive',
  projectsCreate: 'dune:projects:create',
  projectsDelete: 'dune:projects:delete',
  projectsGetSettings: 'dune:projects:get-settings',
  projectsList: 'dune:projects:list',
  projectsSwitch: 'dune:projects:switch',
  projectsUpdateSettings: 'dune:projects:update-settings',
